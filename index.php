      ...
      <div id="main-container">
        ...
        <div id="form-container">
          ...
          <div id="form-holder" class="bg-white box-grey box-rect">
            ...
            <span class="header-3 font-light color-light-blue display-block txt-align-center padding-0">Sign in</span>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" class="padding-20">
              ...
              <button style="margin-bottom: 10px; margin-left: 5px;" class="btn btn-width-100 btn-positive padding-10 margin-top-bottom-5" id="signin" type="submit" name="signin">Sign in</button>
            </form>
          </div>
          <div class="form-container-blank-space"></div>
        </div>
